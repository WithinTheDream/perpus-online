            ...
            <div class="relative z-10 container mx-auto px-4">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="relative bg-white rounded-xl border border-blue-600 transform transition-all duration-300 hover:scale-105 overflow-hidden shadow-lg hover:shadow-2xl transition duration-300">
                        <div class="relative h-56 bg-cover bg-center" style="background-image: url('{{ asset('grid-gallery/bicara seni.jpg') }}');">
                            <div class="absolute top-2 left-2 bg-yellow-400 w-10 h-10 rounded-full flex items-center justify-center shadow-md">
                                <i class="fas fa-star text-white text-lg"></i>
                            </div>
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl font-semibold text-gray-800 mb-3">Bicara Ada Itu Seninya</h4>
                            <p class="text-gray-600 mb-4 text-sm leading-relaxed">
                                Rahasia komunikasi yang efektif karya Oh Su Hyang yang membahas seni berbicara secara lugas dan berpengaruh.
                            </p>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-user mr-2"></i>
                                <span>Oh Su Hyang</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Buku 2: matahari.jpg -->
                    <div class="relative bg-white rounded-xl border border-blue-600 transform transition-all duration-300 hover:scale-105 overflow-hidden shadow-lg hover:shadow-2xl transition duration-300">
                        <div class="relative h-56 bg-cover bg-center" style="background-image: url('{{ asset('grid-gallery/rahasia bersikap.jpg') }}');">
                            <div class="absolute top-2 left-2 bg-yellow-400 w-10 h-10 rounded-full flex items-center justify-center shadow-md">
                                <i class="fas fa-star text-white text-lg"></i>
                            </div>
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl font-semibold text-gray-800 mb-3">Rahasia Bersikap Tenang</h4>
                            <p class="text-gray-600 mb-4 text-sm leading-relaxed">
                                 Panduan bersikap tenang dalam kondisi apa pun, bahkan saat keadaan tidak terkendali. Ditulis oleh Sabrina Ara.
                            </p>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-user mr-2"></i>
                                <span>Sabrina Ara</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Buku 3: saggaras.jpg -->
                    <div class="relative bg-white rounded-xl border border-blue-600 transform transition-all duration-300 hover:scale-105 overflow-hidden shadow-lg hover:shadow-2xl transition duration-300">
                        <div class="relative h-56 bg-cover bg-center" style="background-image: url('{{ asset('grid-gallery/seni berpikir.jpg') }}');">
                            <div class="absolute top-2 left-2 bg-yellow-400 w-10 h-10 rounded-full flex items-center justify-center shadow-md">
                                <i class="fas fa-star text-white text-lg"></i>
                            </div>
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl font-semibold text-gray-800 mb-3">Seni Berpikir Positif</h4>
                            <p class="text-gray-600 mb-4 text-sm leading-relaxed">
                                Buku inspiratif karya Brian Adam yang membahas cara menyikapi hidup secara positif dengan pendekatan ilmiah dan praktis.
                            </p>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-user mr-2"></i>
                                <span>Brian Adam</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Buku 4: bulan.jpg -->
                    <div class="relative bg-white rounded-xl border border-blue-600 transform transition-all duration-300 hover:scale-105 overflow-hidden shadow-lg hover:shadow-2xl transition duration-300">
                        <div class="relative h-56 bg-cover bg-center" style="background-image: url('{{ asset('grid-gallery/seni menguasai lawan bicara.jpg') }}');">
                            <div class="absolute top-2 left-2 bg-yellow-400 w-10 h-10 rounded-full flex items-center justify-center shadow-md">
                                <i class="fas fa-star text-white text-lg"></i>
                            </div>
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl font-semibold text-gray-800 mb-3">Seni Menguasai Lawan Bicara</h4>
                            <p class="text-gray-600 mb-4 text-sm leading-relaxed">
                                Strategi memenangkan pembicaraan dan perdebatan dengan teknik komunikasi yang efektif karya William Andromeda.
                            </p>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-user mr-2"></i>
                                <span>William Andromeda</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Buku 5: bibigill.jpg -->
                    <div class="relative bg-white rounded-xl border border-blue-600 transform transition-all duration-300 hover:scale-105 overflow-hidden shadow-lg hover:shadow-2xl transition duration-300">
                        <div class="relative h-56 bg-cover bg-center" style="background-image: url('{{ asset('grid-gallery/prophet.jpg') }}');">
                            <div class="absolute top-2 left-2 bg-yellow-400 w-10 h-10 rounded-full flex items-center justify-center shadow-md">
                                <i class="fas fa-star text-white text-lg"></i>
                            </div>
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl font-semibold text-gray-800 mb-3">The Prophet</h4>
                            <p class="text-gray-600 mb-4 text-sm leading-relaxed">
                                Karya klasik Kahlil Gibran yang penuh filosofi dan puisi, membahas tema kehidupan, cinta, pekerjaan, dan kebebasan.
                            </p>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-user mr-2"></i>
                    ...
                    <!-- Buku 6: comet.jpg -->
                    <div class="relative bg-white rounded-xl border border-blue-600 transform transition-all duration-300 hover:scale-105 overflow-hidden shadow-lg hover:shadow-2xl transition duration-300">
                        <div class="relative h-56 bg-cover bg-center" style="background-image: url('{{ asset('grid-gallery/power of dicipline.jpg') }}');">
                            <div class="absolute top-2 left-2 bg-yellow-400 w-10 h-10 rounded-full flex items-center justify-center shadow-md">
                                <i class="fas fa-star text-white text-lg"></i>
                            </div>
                        </div>
                        <div class="p-6">
                            <h4 class="text-xl font-semibold text-gray-800 mb-3">The Power of Discipline</h4>
                            <p class="text-gray-600 mb-4 text-sm leading-relaxed">
                                Buku motivasi karya Angga Aris T. tentang pentingnya disiplin diri dalam meraih kesuksesan dan kebebasan pribadi.
                            </p>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-user mr-2"></i>
                                <span>Angga Aris T.</span>
                            </div>
                        </div>
                    </div>
